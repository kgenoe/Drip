...
class DonationsViewController: UIViewController {
    ...
    //MARK: - Life Cycle
    static func instantiate() -> DonationsViewController {
        let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "DonationsViewController") as! DonationsViewController
        return vc
    }
...
extension DonationsViewController: SKProductsRequestDelegate, SKPaymentTransactionObserver {
